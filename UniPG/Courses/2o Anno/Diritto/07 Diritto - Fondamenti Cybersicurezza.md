...
> [!INFO] Da espandere: approfondire la struttura e i requisiti dell'impianto normativo ISO 31000.
...
> [!INFO] Approfondire la teoria generale sulle dinamiche di valutazione del rischio.
...
> [!INFO] Integrare e approfondire l'elenco di ulteriori rischi e minacce informatiche affrontate.

Tra le nuove minacce emergenti, manipolazioni tramite intelligenza artificiale o minacce fisiche:
- **Deepfake**
> [!INFO] Da espandere: studiare meccanismi, impatti legali e privacy connessi all'uso del Deepfake.

- **BadUSB**
> [!INFO] Da espandere: approfondire le dinamiche di infezione hardware tramite dispositivi BadUSB.
